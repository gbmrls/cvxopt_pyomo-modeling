   ...
   "cells": [
    ...
    },
    {
     ...
     "input": [
      ...
      "    m = MinCostFlowInterdiction('/content/drive/MyDrive/Optimizacion_Convexa/01_Warm_up/Network Interdiction/min_cost_flow/sample_nodes_data.csv', '/content/drive/MyDrive/Optimizacion_Convexa/01_Warm_up/Network Interdiction/min_cost_flow/sample_arcs_data.csv')\n",
      "    m.solve()\n",
      "    m.printSolution()\n",
      "    m.attacks = 1\n",
      "    m.solve()\n",
