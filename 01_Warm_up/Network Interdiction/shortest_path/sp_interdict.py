...
if __name__ == '__main__':
    m = SPInterdiction('/content/drive/MyDrive/Optimizacion_Convexa/01_Warm_up/Network Interdiction/shortest_path/sample_nodes_data.csv', '/content/drive/MyDrive/Optimizacion_Convexa/01_Warm_up/Network Interdiction/shortest_path/sample_arcs_data.csv')
    m.solve()
    m.printSolution()
    m.attacks = 1
    m.solve()
