...
if __name__ == '__main__':
    m = MultiCommodityInterdiction('/content/drive/MyDrive/Optimizacion_Convexa/01_Warm_up/Network Interdiction/multi_commodity_flow/sample_nodes_data.csv', '/content/drive/MyDrive/Optimizacion_Convexa/01_Warm_up/Network Interdiction/multi_commodity_flow/sample_nodes_commodity_data.csv', '/content/drive/MyDrive/Optimizacion_Convexa/01_Warm_up/Network Interdiction/multi_commodity_flow/sample_arcs_data.csv', '/content/drive/MyDrive/Optimizacion_Convexa/01_Warm_up/Network Interdiction/multi_commodity_flow/sample_arcs_commodity_data.csv')
    m.solve()
    m.printSolution()
    m.attacks = 1
    m.solve()
